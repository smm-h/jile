...
public class Tetris {
    ...
    // { "tetris.color.background", "color", "The overall background color." },
    // { "tetris.color.label", "color", "The text color of the labels." },
    // { "tetris.color.button", "color", "The start and pause button bolor." },
    // { "tetris.color.board.background", "color", "The background game board
    // color." },
    // { "tetris.color.board.message", "color", "The game board message color." },
    // { "tetris.color.figure.square", "color", "The color of the square figure." },
    // { "tetris.color.figure.line", "color", "The color of the line figure." },
    // { "tetris.color.figure.s", "color", "The color of the 's' curved figure." },
    // { "tetris.color.figure.z", "color", "The color of the 'z' curved figure." },
    // { "tetris.color.figure.right", "color", "The color of the right angle
    // figure." },
    // { "tetris.color.figure.left", "color", "The color of the left angle figure."
    // },
    // { "tetris.color.figure.triangle", "color", "The color of the triangle
    // figure." } };
...
class SquareBoard extends Object {
    ...
    /**
     * The square board color matrix. This matrix (or grid) contains a color entry
     * for each square in the board. The matrix is indexed by the vertical, and then
     * the horizontal coordinate.
     */
    private Color[][] matrix = null;

    /**
     * An optional board message. The board message can be set at any time, printing
     * it on top of the board.
     */
    private String message = null;

    /**
     * The number of lines removed. This counter is increased each time a line is
     * removed from the board.
     */
    private int removedLines = 0;

    /**
     * The graphical sqare board component. This graphical representation is created
     * upon the first call to getComponent().
     */
     ...
     * If the square is outside the board, false will be returned in all cases
     * except when the square is directly above the board.
     *
    ...
    /**
     * Checks if a specified line is empty, i.e. only contains empty squares. If the
     * line is outside the board, false will always be returned.
     *
     * @param y the vertical position (0 <= y < height)
     * 
    ...
    /**
     * Checks if a specified line is full, i.e. only contains no empty squares. If
     * the line is outside the board, true will always be returned.
     *
     * @param y the vertical position (0 <= y < height)
     * 
    ...
    /**
     * Returns a graphical component to draw the board. The component returned will
     * automatically be updated when changes are made to this board. Multiple calls
     * to this method will return the same component, as a square board can only
     * have a single graphical representation.
     * 
    ...
    /**
     * Returns the board height (in squares). This method returns, i.e, the number
     * of vertical squares that fit on the board.
     * 
    ...
    /**
     * Returns the board width (in squares). This method returns, i.e, the number of
     * horizontal squares that fit on the board.
     * 
    ...
    /**
     * Changes the color of an individual square on the board. The square will be
     * marked as in need of a repaint, but the graphical component will NOT be
     * repainted until the update() method is called.
     *
     * @param x     the horizontal position (0 <= x < width)
     * @param y     the vertical position (0 <= y < height)
    ...
    /**
     * Sets a message to display on the square board. This is supposed to be used
     * when the board is not being used for active drawing, as it slows down the
    ...
    /**
     * Clears the board, i.e. removes all the colored squares. As side-effects, the
     * number of removed lines will be reset to zero, and the component will be
    ...
    /**
     * Removes all full lines. All lines above a removed line will be moved downward
     * one step, and a new empty line will be added at the top. After removing all
     * full lines, the component will be repainted.
     * 
     * @see #hasFullLines
     */
     ...
     * empty line is added at the top. No repainting will be done after removing the
     * line.
     *
     * @param y the vertical position (0 <= y < height)
     */
    ...
    /**
     * The graphical component that paints the square board. This is implemented as
     * an inner class in order to better abstract the detailed information that must
     * be sent between the square board and its graphical representation.
     */
    private class SquareBoardComponent extends JComponent {

        /**
         * The component size. If the component has been resized, that will be detected
         * when the paint method executes. If this value is set to null, the component
         * dimensions are unknown.
         */
        private Dimension size = null;

        /**
         * The component insets. The inset values are used to create a border around the
         * board to compensate for a skewed aspect ratio. If the component has been
         * resized, the insets values will be recalculated when the paint method
         * executes.
         */
        private Insets insets = new Insets(0, 0, 0, 0);

        /**
         * The square size in pixels. This value is updated when the component size is
         * changed, i.e. when the <code>size</code> variable is modified.
         */
        private Dimension squareSize = new Dimension(0, 0);

        /**
         * An image used for double buffering. The board is first painted onto this
         * image, and that image is then painted onto the real surface in order to avoid
         * making the drawing process visible to the user. This image is recreated each
         * time the component size changes.
         */
        private Image bufferImage = null;

        /**
         * A clip boundary buffer rectangle. This rectangle is used when calculating the
         * clip boundaries, in order to avoid allocating a new clip rectangle for each
         * board square.
         */
        ...
        /**
         * A lookup table containing lighter versions of the colors. This table is used
         * to avoid calculating the lighter versions of the colors for each and every
         * square drawn.
         */
        private HashMap<Color, Color> lighterColors = new HashMap<Color, Color>();

        /**
         * A lookup table containing darker versions of the colors. This table is used
         * to avoid calculating the darker versions of the colors for each and every
         * square drawn.
         */
        ...
        /**
         * Redraws all the invalidated squares. If no squares have been marked as in
         * need of redrawing, no redrawing will occur.
         */
        public void redraw() {
            Graphics g;
        ...
        /**
         * Returns a lighter version of the specified color. The lighter color will
         * looked up in a hashtable, making this method fast. If the color is not found,
         * the ligher color will be calculated and added to the lookup table for later
         * reference.
         * 
        ...
        /**
         * Returns a darker version of the specified color. The darker color will looked
         * up in a hashtable, making this method fast. If the color is not found, the
         * darker color will be calculated and added to the lookup table for later
         * reference.
         * 
         * @param c the base color
         * 
        ...
        /**
         * Paints this component indirectly. The painting is first done to a buffer
         * image, that is then painted directly to the specified graphics context.
         * 
        ...
        /**
         * Paints this component directly. All the squares on the board will be painted
         * directly to the specified graphics context.
         * 
         * @param g the graphics context to use
         */
        ...
        /**
         * Paints a single board square. The specified position must contain a color
         * object.
         *
         * @param g the graphics context to use
         * @param x the horizontal position (0 <= x < width)
        ...
        /**
         * Paints a board message. The message will be drawn at the center of the
         * component.
         *
         * @param g   the graphics context to use
...
class Game extends Object {
    ...
    /**
     * The PropertyChangeSupport Object able to register listener and dispatch
     * events to them.
     */
    ...
    /**
     * The figures used on both boards. All figures are reutilized in order to avoid
     * creating new objects while the game is running. Special care has to be taken
     * when the preview figure and the current figure refers to the same object.
     */
    ...
    /**
     * The thread that runs the game. When this variable is set to null, the game
     * thread will terminate.
     */
    private final GameThread thread;

    /**
     * The game level. The level will be increased for every 20 lines removed from
     * the square board.
     */
    private int level = 1;

    /**
     * The current score. The score is increased for every figure that is possible
     * to place on the main board.
     */
    private int score = 0;
    ...
    /**
     * The figure preview flag. If this flag is set, the figure will be shown in the
     * figure preview board.
     */
    private boolean preview = true;

    /**
     * The move lock flag. If this flag is set, the current figure cannot be moved.
     * This flag is set when a figure is moved all the way down, and reset when a
     * new figure is displayed.
     */
    ...
    /**
     * Creates a new Tetris game. The square board will be given the default size of
     * 10x20.
     */
    public Game() {
        this(20, 25);
     ...
     * 
     * name: "level" value: current level (int) when: fired when the player moves to
     * the next level.
     * 
     * name: "score" value: current score (int) when: fired when the player
     * increases his/her score.
     * 
     * name: "lines" value: number of 'removed' lines (int) when: fired when the
     * player removes one or more lines.
     * 
    ...
    /**
     * Initializes the game ready if the state is on STATE_GAMEOVER otherwise it
     * does nothing.
     **/
    public void init() {
    ...
    /**
     * Handles a game start event. Both the main and preview square boards will be
     * reset, and all other game parameters will be reset. Finally the game thread
     * will be launched.
     */
    ...
    /**
     * Handles a game over event. This will stop the game thread, reset all figures
    ...
    /**
     * Handles a getReady event. This will print a 'get ready' message on the game
     * board.
     */
    ...
    /**
     * Handles a game pause event. This will pause the game thread and print a pause
    ...
    /**
     * Handles a game resume event. This will resume the game thread and remove any
     * messages on the game board.
     */
    ...
    /**
     * Handles a figure start event. This will move the next figure to the current
     * figure position, while also creating a new preview figure. If the figure
     * cannot be introduced onto the game board, a game over event will be launched.
     */
    ...
    /**
     * Handles a figure landed event. This will check that the figure is completely
     * visible, or a game over event will be launched. After this control, any full
     * lines will be removed. If no full lines could be removed, a figure start
     * event is launched directly.
     */
    ...
    /**
     * Handles a timer event. This will normally move the figure down one step, but
     * when a figure has landed or isn't ready other events will be launched. This
     * method is synchronized to avoid race conditions with other asynchronous
    ...
    /**
     * Handles a button press event. This will launch different events depending on
     * the state of the game, as the button semantics change as the game changes.
     * This method is synchronized to avoid race conditions with other asynchronous
     * events (timer and keyboard).
     */
    ...
    /**
     * Handles a keyboard event. This will result in different actions being taken,
     * depending on the key pressed. In some cases, other events will be launched.
     * This method is synchronized to avoid race conditions with other asynchronous
     * events (timer and mouse).
     * 
    ...
    /**
     * Returns a random figure. The figures come from the figures array, and will
     * not be initialized.
     * 
     ...
     * launched appropriately, making the current figure fall. This thread can be
     * reused across games, but should be set to paused state when no game is
     * running.
     */
    private class GameThread extends Thread {
        ...
        /**
         * The number of milliseconds to sleep before each automatic move. This number
         * will be lowered as the game progresses.
         */
        ...
        /**
         * Resets the game thread. This will adjust the speed and start the game thread
        ...
        /**
         * Adjusts the game speed according to the current level. The sleeping time is
         * calculated with a function making larger steps initially an smaller as the
         * level increases. A level above ten (10) doesn't have any further effect.
         */
...
/**
 * A program configuration. This class provides static methods for simplifying
 * the reading of configuration parameters. It also provides some methods for
 * transforming string values into more useful objects.
 * 
 * @author Per Cederberg, per@percederberg.net
 * @version 1.2
 */
class Configuration {
    ...
    /**
     * The internal configuration property values. This lookup table is used to
     * avoid setting configuration parameters in the system properties, as some
     * programs (applets) do not have the security permissions to set system
     * properties.
     */
    ...
    /**
     * Returns a configuration parameter value. If the configuration parameter is
     * not set, a default value will be returned instead.
     * 
     * @param key the configuration parameter key
    ...
    /**
     * Returns the color configured for the specified key. The key will be prepended
     * with "tetris.color." and the value will be read from the system properties.
     * The color value must be specified in hexadecimal web format, i.e. in the
     * "#RRGGBB" format. If the default color isn't in a valid format, white will be
     * returned.
     * 
     * @param key the configuration parameter key
    ...
    /**
     * Parses a web color string. If the color value couldn't be parsed correctly,
     * null will be returned.
     * 
     * @param value the color value to parse
     * 
     * @return the color represented by the string, or null if the string was
     *         malformed
     */
...
class Figure extends Object {
    ...
    /**
     * The square board to which the figure is attached. If this variable is set to
     * null, the figure is not attached.
     */
    private SquareBoard board = null;

    /**
     * The horizontal figure position on the board. This value has no meaning when
     * the figure is not attached to a square board.
     */
    private int xPos = 0;

    /**
     * The vertical figure position on the board. This value has no meaning when the
     * figure is not attached to a square board.
     */
    private int yPos = 0;

    /**
     * The figure orientation (or rotation). This value is normally between 0 and 3,
     * but must also be less than the maxOrientation value.
     * 
     * @see #maxOrientation
     */
    ...
    /**
     * The maximum allowed orientation number. This is used to reduce the number of
     * possible rotations for some figures, such as the square figure. If this value
     * is not used, the square figure will be possible to rotate around one of its
     * squares, which gives an erroneous effect.
     * 
     * @see #orientation
     */
    ...
    /**
     * The horizontal coordinates of the figure shape. The coordinates are relative
     * to the current figure position and orientation.
     */
    private int[] shapeX = new int[4];

    /**
     * The vertical coordinates of the figure shape. The coordinates are relative to
     * the current figure position and orientation.
     */
     ...
     * not be attached to any square board and default colors and orientations will
     * be assigned.
     *
     ...
     * @see #TRIANGLE_FIGURE
     * 
     * @throws IllegalArgumentException if the figure type specified is not
     *                                  recognized
     */
     ...
     * either at the absolute top of the board, with only the bottom line visible,
     * or centered onto the board. In both cases, the squares on the new board are
     * checked for collisions. If the squares are already occupied, this method
     * returns false and no attachment is made.
     * <p>
     *
     * The horizontal and vertical coordinates will be reset for the figure, when
     * centering the figure on the new board. The figure orientation (rotation) will
     * be kept, however. If the figure was previously attached to another board, it
     * will be detached from that board before attaching to the new board.
     *
    ...
    /**
     * Checks if the figure has landed. If this method returns true, the moveDown()
     * or the moveAllWayDown() methods should have no effect. If no square board is
     * attached, this method will return true.
     *
     ...
     * changed as the figure moves, clearing the previous cells. If no square board
     * is attached, nothing is done.
     */
    ...
    /**
     * Moves the figure one step to the right. If such a move is not possible with
     * respect to the square board, nothing is done. The square board will be
     * changed as the figure moves, clearing the previous cells. If no square board
     * is attached, nothing is done.
     */
    ...
    /**
     * Moves the figure one step down. If such a move is not possible with respect
     * to the square board, nothing is done. The square board will be changed as the
     * figure moves, clearing the previous cells. If no square board is attached,
     * nothing is done.
     */
    ...
    /**
     * Moves the figure all the way down. The limits of the move are either the
     * square board bottom, or squares not being empty. If no move is possible with
     * respect to the square board, nothing is done. The square board will be
     * changed as the figure moves, clearing the previous cells. If no square board
     * is attached, nothing is done.
     */
     ...
     * possible with respect to the square board, nothing is done. The square board
     * will be changed as the figure moves, clearing the previous cells. If no
     * square board is attached, the rotation is performed directly.
     * 
    ...
    /**
     * Rotates the figure randomly. If such a rotation is not possible with respect
     * to the square board, nothing is done. The square board will be changed as the
     * figure moves, clearing the previous cells. If no square board is attached,
    ...
    /**
     * Rotates the figure clockwise. If such a rotation is not possible with respect
     * to the square board, nothing is done. The square board will be changed as the
     * figure moves, clearing the previous cells. If no square board is attached,
     * the rotation is performed directly.
     */
    ...
    /**
     * Rotates the figure counter-clockwise. If such a rotation is not possible with
     * respect to the square board, nothing is done. The square board will be
     * changed as the figure moves, clearing the previous cells. If no square board
     * is attached, the rotation is performed directly.
     */
    ...
    /**
     * Checks if a specified pair of (square) coordinates are inside the figure, or
     * not.
     *
    ...
    /**
     * Checks if the figure can move to a new position. The current figure position
     * is taken into account when checking for collisions. If a collision is
     * detected, this method will return false.
     *
    ...
    /**
     * Rotates the relative vertical position of a specified square. The square will
     * be rotated according to the specified orientation.
     *
     * @param square      the square to rotate (0-3)
     * @param orientation the orientation to use (0-3)
     * 
